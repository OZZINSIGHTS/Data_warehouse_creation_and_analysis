-----------total sales of the company over years-------------
SELECT YEAR(order_date) YEARS , SUM(sales_amount) SALESAMOUNT
...
-------- a manual comparison shows that sales significally dropped from dec 2013 to jan 2014 by -69.12% then by -97.40% in Feb as the last month where records had ended.
